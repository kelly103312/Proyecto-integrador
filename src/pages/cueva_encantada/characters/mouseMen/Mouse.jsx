...
export default function Mouse({position}) {
  ...
  const { nodes, materials } = useGLTF('/assets/cueva_encantada/models/mouse-mens/Player1.glb')
  const amplitude = 1
...
useGLTF.preload("/assets/cueva_encantada/models/mouse-mens/Player1.glb");
